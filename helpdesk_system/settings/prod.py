...
# Use CompressedStaticFilesStorage instead of Manifest version to avoid manifest issues
# The manifest version requires perfect collectstatic execution, which can fail in containers
